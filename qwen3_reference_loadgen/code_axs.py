"""
    ...
    [Session 1]$ docker run --gpus all -v /mnt/data:/mnt/data -p 8000:8000 --ipc=host vllm/vllm-openai:latest --served-model-name Qwen/Qwen3-VL-235B-A22B-Instruct --model /mnt/data/krai/mlcommons-storage/models/vlm_model/Qwen3-VL-235B-A22B-Instruct --tensor-parallel-size 8 --limit-mm-per-prompt.video 0 --no-enable-prefix-caching
